...
namespace PlayerControlByOris
{
    ...
    public partial class PlayerControlComponent : EccComponent
    {
		...
		[BoxGroup("角色基本属性"),Tooltip("角色在脚本内可以被控制的速度"),ShowInInspector,ReadOnly]
		...
		[BoxGroup("角色运行计时器"),Tooltip("失控水平移动计时器（单位：帧）"),ShowInInspector,ReadOnly]
		...
		[BoxGroup("重力相关"),Tooltip("正常的下落加速度（单位：/帧）"),ShowInInspector,OdinSerialize,]
		...
		[BoxGroup("水平方向移动相关"),Tooltip("正常水平方向的最大速度"),ShowInInspector,OdinSerialize,]
		public float MaxSpeedX { get; set; }

		[BoxGroup("水平方向移动相关"),Tooltip("水平方向上的加速度（单位：/帧）"),ShowInInspector,OdinSerialize,]
		public float AccX { get; set; }

		[BoxGroup("水平方向移动相关"),Tooltip("角色水平方向上超速的减速度（单位：/帧）"),ShowInInspector,OdinSerialize,]
		public float OverReduceX { get; set; }

		[BoxGroup("水平方向移动相关"),Tooltip("角色在空中的加速度倍率"),ShowInInspector,OdinSerialize,]
		...
		[BoxGroup("跳跃相关"),Tooltip("角色起跳时水平方向获得的额外速度倍率"),ShowInInspector,OdinSerialize,]
		public float JumpBoostMultX { get; set; }

		[BoxGroup("跳跃相关"),Tooltip("角色起跳时水平方向获得的额外速度"),ShowInInspector,ReadOnly,]
		public float JumpBoostSpeedX => JumpBoostMultX * MaxSpeedX;

		[BoxGroup("跳跃相关"),Tooltip("角色最少的跳跃时长（单位：帧）"),ShowInInspector,OdinSerialize,]
		public int MinJumpTime { get; set; }

		[BoxGroup("跳跃相关"),Tooltip("角色最长的跳跃时长（单位：帧）"),ShowInInspector,OdinSerialize,]
